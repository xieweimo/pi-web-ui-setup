...
$permanentProjectIgnorePatch = Join-Path $cwd 'patches\patch-pi-web-ui-permanent-project-ignore.js'
...
foreach ($patch in @($usageCostPatch, $liveModelPatch, $recoveryUiPatch, $hideForkedPatch, $permanentProjectIgnorePatch)) {
