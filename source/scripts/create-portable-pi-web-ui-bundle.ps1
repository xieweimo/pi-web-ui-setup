...
$items = @('configs\pi-settings.template.json','configs\global-AGENTS.md','configs\models-store.json','configs\pi-web-ui-profiles','docs\after-install-checklist.md','extras','patches','projects\codex-usage-plugin','projects\piwork-tools-plugin','scripts\install-aiwork.ps1','scripts\install-plugins.js','scripts\apply-pi-web-ui-profile.js','scripts\pi-web-ui-locate.js','scripts\pi-web-ui-launcher.ps1','scripts\pi-web-ui-recovery-watchdog.js','scripts\resolve-proxy.ps1')
